...
public class US05 {
    ...
    @Test
    public void testStartWithAStrikeForm () {
    ...
    @Test
    public void testStartWithAStrikeContent () {
        final BowlingGame game = new BowlingGame();
        game.addFrame( new Frame( 10, 0 ) );
    ...
    @Test
    public void testStrikeInTheMiddleForm () {
        final BowlingGame game = new BowlingGame();
    ...
    @Test
    public void testStrikeInTheMiddleContent () {
        final BowlingGame game = new BowlingGame();
        game.addFrame( new Frame( 5, 1 ) );
    ...
    @Test
    public void testSingleStrikeZeroContentsForm () {
        final BowlingGame game = new BowlingGame();
        game.addFrame( new Frame( 10, 0 ) );
        game.addFrame( new Frame( 0, 0 ) );
        game.addFrame( new Frame( 0, 0 ) );
