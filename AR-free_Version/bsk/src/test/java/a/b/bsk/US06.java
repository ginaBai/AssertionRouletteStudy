...
public class US06 {
    ...
    @Test
    public void testStartWithASpareForm () {
    ...
    @Test
    public void testStartWithASpareContent () {
        final BowlingGame game = new BowlingGame();
    ...
    @Test
    public void testSpareWithFirstThrowZeroForm () {
        final BowlingGame game = new BowlingGame();
    ...
    @Test
    public void testSpareInTheMiddleForm () {
        final BowlingGame game = new BowlingGame();
    ...
    @Test
    public void testSpareInTheMiddleContent () {
        final BowlingGame game = new BowlingGame();
        game.addFrame( new Frame( 5, 1 ) );
    ...
    @Test
    public void testSingleSpareZeroBonusForm () {
        final BowlingGame game = new BowlingGame();
        game.addFrame( new Frame( 5, 5 ) );
        game.addFrame( new Frame( 0, 0 ) );
        game.addFrame( new Frame( 1, 1 ) );
